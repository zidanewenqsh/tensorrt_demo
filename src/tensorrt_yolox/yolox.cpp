...
Yolox::Yolox(std::string& name, int buffer_size) 
...
int Yolox::preprocess(cv::Mat &img) {
    // 前处理
...
void Yolox::drawimg(cv::Mat &img, const std::string& savepath) {
    // 绘制
...
int Yolox::forward_image(std::string &img_file) {
